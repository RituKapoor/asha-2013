...
//import com.nokia.mid.appl.sa.io.contacts.ContactsConnection;
//import com.nokia.mid.appl.sa.io.contacts.ContactsEventListener;
//import com.nokia.mid.appl.sa.io.contacts.ContactsException;
//import com.nokia.mid.appl.sa.io.contacts.data.*;
import java.io.IOException;
import java.util.Vector;
import com.nokia.j2me.pim.*;
 ...
 * @author Shreyas
 */
public class ContactHandler implements ContactChangeListener, AppConstants {
...
//    private byte change = -1;
    ...
    public void handleNotifyEvent(byte change, Contact con) {
        //  this.change = change;
    }
    ...
    private void addContact(Contact contact, Vector/*<AddressBookRequestEntry>*/ contactsVector) {
        ...
        if (numbers != null) {
            for (int k = 0; k < numbers.length; k++) {
                String number = numbers[k].getNumber();
